...
// Only in v2.2.0 and higher
#ifdef SCMP_ARCH_AARCH64
const uint32_t C_ARCH_AARCH64      = SCMP_ARCH_AARCH64;
#else
const uint32_t C_ARCH_AARCH64      = 0;
#endif
...
func sanitizeArch(in ScmpArch) error {
	...
	} else if in == ArchARM64 && C.C_VERSION_MAJOR == 2 && C.C_VERSION_MINOR < 2 {
		return fmt.Errorf("AArch64 is not supported before Libseccomp 2.2")
	}
